function __fish_preexec_set_prompt_wall_clock --on-event fish_preexec --description "Set wall clock time before command executes"
    set -g __wall_clock_time_pre (date +"%T.%3N")
